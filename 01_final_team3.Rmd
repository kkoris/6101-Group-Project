...
library(readr)
Counties_Dataset <- read_csv("~/Documents/GitHub/22Sum_Dats6101/6101-Group-Project/Counties Dataset.csv")
...
```
```{r, results='markup'}
qqplot(count_df_clean$`Average Number of Mentally Unhealthy Days`, count_df_clean$Total_cases, main = "QQ Plot of Total cases",
...
```
Team, I think our data is not normal. We can several things form here. We can try to employ methods that will fix the normality or we may want to change the model of analysis. I am sending you all a note via email.
