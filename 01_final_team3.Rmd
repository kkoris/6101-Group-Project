...
## Make sure to include these in the descriptive stats Totcaspopn ~ Menunhlthdays + Blacks + Hispanics + Asians + White + PDSqmile + HDSqmile + ColEduc + Socialize + HseCrowded + Diabetic + PoorHlth + Smokers + Fluvax +RespDisease + Population

## Descriptive Statistics

```{r eval=FALSE}
library(ezids)
xkablesummary(clean, title = "Summary of COVID Data")
```
