...
library(rpart)
set.seed(1)
fit <- rpart(Totcaspopn ~ Deaths + Population + Blacks + Asians + PoorHlth + Menunhlthdays + Smokers, clean, method="class", control = list(maxdepth = 5) )

printcp(fit)
plotcp(fit)
summary(fit)
#plot tree
#plot(fit, uniform=TRUE, main="Classification Tree for Churn")
#text(fit, use.n=TRUE, all=TRUE, cex=.8)

#please modify this and after monday meet with professor to built the tree 
```
