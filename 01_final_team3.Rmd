...
Data Inspection and measures of central tendency
...
ggplot(finalclean, aes(x=Population)) + geom_histogram(fill="steelblue", color="black") + ggtitle("Histogram of Total Cases")

ggplot(finalclean, aes(x=Blacks)) + geom_histogram(fill="steelblue", color="black") + ggtitle("Histogram of Total Cases")

ggplot(finalclean, aes(x=ColEduc)) + geom_histogram(fill="steelblue", color="black") + ggtitle("Histogram of Total Cases")

ggplot(finalclean, aes(x=HseCrowded)) + geom_histogram(fill="steelblue", color="black") + ggtitle("Histogram of Total Cases")

ggplot(finalclean, aes(x=Menunhlthdays)) + geom_histogram(fill="steelblue", color="black") + ggtitle("Histogram of Total Cases")

ggplot(finalclean, aes(x=finalclean$Smokers)) + geom_histogram(fill="steelblue", color="black") + ggtitle("Histogram of Total Cases")
...
```
## The relationship between total cases per population and each of the explanatory variables

```{r, results='markup'}

ggplot(finalclean, aes(x=Menunhlthdays, y=Totcaspopn)) + geom_point()
ggplot(finalclean, aes(x=Blacks, y=Totcaspopn)) + geom_point()
ggplot(finalclean, aes(x=finalclean$Population, y=Totcaspopn)) + geom_point()
ggplot(finalclean, aes(x=finalclean$ColEduc, y=Totcaspopn)) + geom_point()
ggplot(finalclean, aes(x=finalclean$HseCrowded, y=Totcaspopn)) + geom_point()
ggplot(finalclean, aes(x=finalclean$Smokers, y=Totcaspopn)) + geom_point()
